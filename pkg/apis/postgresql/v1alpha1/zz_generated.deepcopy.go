...
func (in *PostgresqlDatabaseSpec) DeepCopyInto(out *PostgresqlDatabaseSpec) {
	*out = *in
	...
	if in.EngineConfiguration != nil {
		...
		*out = new(PostgresqlEngineConfigurationLink)
		**out = **in
	}
	return
}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *PostgresqlEngineConfigurationLink) DeepCopyInto(out *PostgresqlEngineConfigurationLink) {
	*out = *in
	return
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new PostgresqlEngineConfigurationLink.
func (in *PostgresqlEngineConfigurationLink) DeepCopy() *PostgresqlEngineConfigurationLink {
	if in == nil {
		return nil
	}
	out := new(PostgresqlEngineConfigurationLink)
