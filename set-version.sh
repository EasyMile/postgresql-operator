...
replace_value_in_file ".*image: " "easymile\/postgresql-operator:$1" "deploy/operator.yaml"
replace_value_in_file ".*tag: " "$1" "deploy/helm/postgresql-operator/values.yaml"
